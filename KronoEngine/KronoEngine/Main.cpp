...
void ConfigureScene() {
	renderer.SetGlobalLightParameters(glm::vec3(-100.0f, 100.0f, -100.0f), 0.4f, glm::ivec4(255, 255, 255, 255), 100.0f);

	renderer.AddCamera(glm::vec3(0.0f, 3.0f, 5.0f), glm::vec3(0.0f, 0.0f, 0.0f));
	...
	renderer.AddMesh("../Media/Meshes/Kedi/kedi-static.km", glm::vec3(2.0f, 0.5f, 0.0f));
